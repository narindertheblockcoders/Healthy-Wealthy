...
const Verification = ()=>{
    ...
    async function resendCode() {
        ...
        try {
            let res = await axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/resend", {
                email: email
            });
            const data = res.data;
...
const verification = ()=>{
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        children: [
            ...
            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Component_Verification__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z, {})
        ]
    });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (verification);
