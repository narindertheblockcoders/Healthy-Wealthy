...
const Footer = () => {
  return (
    ...
    <p class="text-center text-muted">© 2022 HealthiWealthi™. All rights reserved | <a href="#" class="form-script-tag-3443593" style={{textDecoration:"none", color:"#D32286", fontWeight:"600"}}>Contact us </a>
