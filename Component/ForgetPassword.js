        ...
        <div className="container">
          ...
          />
            <form className="input-sec" onSubmit={onSubmitHandler}>
              ...
              {/* <Link href={"/login"}> */}
              {error && (<p style={{ color: "red", fontSize:"13px", fontWeight:"600", margin:"0" }}> Invalid Code </p>)}
              {verify && (
                  <p style={{ color: "green", fontSize:"13px",  fontWeight:"600", margin:"0" }}> Password Changed</p>
                )}
              <button
