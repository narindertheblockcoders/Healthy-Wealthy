          ...
          <div className="row justify-content-center">
            <form className="funds-sec" >
              ...
              <div className='invest-part'>
                ...
                <h3 style={{color:"black", fontSize:"22px", fontWeight:"bold", margin:"0", }}>Buy RXHEAL</h3>
           {/* <div className='invest-line'></div> */}
              ...
              <div className='invest-part mt-5'>
                ...
                <div className="input-line  "></div>
                  <div className='invest-box'>
                    <h4 className='heal-text'>RXHEAL $100+</h4></div>
            ...
            <button className='invest-btn mt-4 mb-3' type='button' > CONTINUE</button>
                  </div>
                    </div>
                  </div>
                ...
                <div className='invest-box1'>
                    <h4 className='own-text'>Own 100,000 RXHEAL </h4>
                    <h5 className='rx-text'  id='tick-sec'> <span>500</span> RXHEAL Bonus Tokens</h5>
                    <h5 className='rx-text' >  <div id='tick-sec'> Book HealthiWealthi ($15 value)</div> </h5>
                    <div className='tick-sec'>
                    <div className='check-head mt-2'  id='tick-sec'></div>
            ...
            <button className='invest-btn mt-4 mb-3' type='button' > CONTINUE</button>
                ...
                <div className='invest-box1'>
                    <h4 className='own-text'>Own 100,000 RXHEAL </h4>
                    <h5 className='rx-text' id='tick-sec'> <span style={{color:"#D32286", fontWeight:"bold"}}>5,000</span> RXHEAL Bonus Tokens</h5>
                    <h5 className='rx-text' >  <div id='tick-sec'> Book HealthiWealthi ($15 value)</div> </h5>               
                    <div className='tick-sec'>
                    <div className='check-head mt-2'  id='tick-sec'></div>
                    <h5 className='rx-text'> The Art & Science of Self-Healing 101 Course ($297 value)</h5>
