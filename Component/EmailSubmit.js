...
healthier, happier, longer, and richer.</p>
              ...
              {error && (
                  <p style={{ color: "red", fontWeight:"500", fontSize:"15px", margin:"0" }}> Invalid Email </p>
                )}
                 {verify && (
                  <p style={{ color: "green", fontSize:"15px", fontWeight:"500", margin:"0" }}> Verification code Sent </p>
                )}
